            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <p class="signup-link register">Already have an account? <a href="{{route('admin.loginpage')}}">Log in</a></p>
                        <form class="text-left"method="post" action ="{{route('admin.signup')}}">
                            <div class="form" >
                               @csrf
