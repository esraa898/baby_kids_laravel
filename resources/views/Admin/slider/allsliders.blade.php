                                ...
                                <div class="widget-header">
                                    <div class="row">
                                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                            <h4>Sliders'S Table</h4>
                                            <button class="btn btn-info"> <a href="{{route('admin.slider.create')}}" >Add New Slider</a> </button>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered mb-4">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td> <img src= "{{asset( $slider->img)}}" width="150px" height="150px"></td>
