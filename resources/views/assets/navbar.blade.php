...
<head>
    ...
    <title>BABY KIDS HTML</title> <!--insert your title here-->  
    ...
    <!--START CSS--> 
    <link rel="stylesheet" href="{{asset('Userassets/css/nicdark_style.css')}}"> <!--style-->
    <link rel="stylesheet" href="{{asset('Userassets/css/nicdark_responsive.css')}}"> <!--nicdark_responsive-->
    <link rel="stylesheet" href="{{asset('Userassets/css/fontello.css')}}">

    <!--revslider-->
    <link rel="stylesheet" href="{{asset('Userassets/css/revslider/settings.css')}}"> <!--revslider-->
    ...
    <!--FAVICONS-->
    <link rel="shortcut icon" href="{{asset('Userassets/img/favicon/favicon.ico')}}">
    <link rel="apple-touch-icon" href="{{asset('Userassets/img/favicon/apple-touch-icon.png')}}">
    <link rel="apple-touch-icon" sizes="72x72" href="{{asset('Userassets/img/favicon/apple-touch-icon-72x72.png')}}">
    <link rel="apple-touch-icon" sizes="114x114" href="{{asset('Userassets/img/favicon/apple-touch-icon-114x114.png')}}">
    <!--END FAVICONS-->
...
<div class="nicdark_right_sidebar nicdark_bg_greydark nicdark_nicescrool">
    ...
    <div class="nicdark_textevidence">
        <div class="nicdark_margin20">
            <ul class="nicdark_list nicdark_relative">
                <li>
                    <img alt=""  class="nicdark_absolute nicdark_radius nicdark_opacity nicdark_width60" src="{{asset('Userassets/img/woocommerce/small/img1.jpg')}}">
                ...
                <li>
                    <img alt=""  class="nicdark_absolute nicdark_radius nicdark_opacity nicdark_width60" src="{{asset('Userassets/img/woocommerce/small/img3.jpg')}}">
                    <div class="nicdark_activity nicdark_marginleft80">
    ...
    <div class="nicdark_textevidence">
        <div class="nicdark_margin20">
            <ul class="nicdark_list nicdark_relative">
                <li>
                    <img alt=""  class="nicdark_absolute nicdark_radius nicdark_opacity nicdark_width60" src="{{asset('Userassets/img/woocommerce/small/img2.jpg')}}">
                    <div class="nicdark_activity nicdark_marginleft80">
                ...
                <li>
                    <img alt=""  class="nicdark_absolute nicdark_radius nicdark_opacity nicdark_width60" src="{{asset('Userassets/img/woocommerce/small/img4.jpg')}}">
                    <div class="nicdark_activity nicdark_marginleft80">
