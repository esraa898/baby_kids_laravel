    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_3 nomargin percentage">
            ...
            <div class="grid nomargin grid_4 percentage">
                <div class="nicdark_margin10">
                    <img alt="" class="nicdark_radius nicdark_opacity nicdark_focus" src="{{asset('Userassets/img/footer/img1.jpg')}}">
                </div>
            </div>
            
            <div class="grid nomargin grid_4 percentage">
                <div class="nicdark_margin10">
                    <img alt="" class="nicdark_radius nicdark_opacity nicdark_focus" src="{{asset('Userassets/img/footer/img2.jpg')}}">
                </div>
            </div>
            
            <div class="grid nomargin grid_4 percentage">
                <div class="nicdark_margin10">
                    <img alt="" class="nicdark_radius nicdark_opacity nicdark_focus" src="{{asset('Userassets/img/footer/img3.jpg')}}">
                </div>
            </div>
            
            <div class="grid nomargin grid_4 percentage">
                <div class="nicdark_margin10">
                    <img alt="" class="nicdark_radius nicdark_opacity nicdark_focus" src="{{asset('Userassets/img/footer/img4.jpg')}}">
                </div>
            </div>
            
            <div class="grid nomargin grid_4 percentage">
                <div class="nicdark_margin10">
                    <img alt="" class="nicdark_radius nicdark_opacity nicdark_focus" src="{{asset('Userassets/img/footer/img5.jpg')}}">
                </div>
            </div>
            
            <div class="grid nomargin grid_4 percentage">
                <div class="nicdark_margin10">
                    <img alt="" class="nicdark_radius nicdark_opacity nicdark_focus" src="{{asset('Userassets/img/footer/img6.jpg')}}">
                </div>
            </div>
...
<!--end section-->
    ...
    <!--main-->
    <script src="{{asset('Userassets/js/main/jquery.min.js')}}"></script> <!--Jquery-->
    <script src="{{asset('Userassets/js/main/jquery-ui.js')}}"></script> <!--Jquery UI-->
    <script src="{{asset('Userassets/js/main/excanvas.js')}}"></script> <!--canvas need for ie-->

    <!--plugins-->
    <script src="{{asset('Userassets/js/plugins/revslider/jquery.themepunch.tools.min.js')}}"></script> <!--revslider-->
    <script src="{{asset('Userassets/js/plugins/revslider/jquery.themepunch.revolution.min.js')}}"></script> <!--revslider-->

    <!--menu-->
    <script src="{{asset('Userassets/js/plugins/menu/superfish.min.js')}}"></script> <!--superfish-->
    <script src="{{asset('Userassets/js/plugins/menu/tinynav.min.js')}}"></script> <!--tinynav-->

    <!--other-->
    <script src="{{asset('Userassets/js/plugins/isotope/isotope.pkgd.min.js')}}"></script> <!--isotope-->
    <script src="{{asset('Userassets/js/plugins/mpopup/jquery.magnific-popup.min.js')}}"></script> <!--mpopup-->
    <script src="{{asset('Userassets/js/plugins/scroolto/scroolto.js')}}"></script> <!--Scrool To-->
    <script src="{{asset('Userassets/js/plugins/nicescrool/jquery.nicescroll.min.js')}}"></script> <!--Nice Scroll-->
    <script src="{{asset('Userassets/js/plugins/inview/jquery.inview.min.js')}}"></script> <!--inview-->
    <script src="{{asset('Userassets/js/plugins/parallax/jquery.parallax-1.1.3.js')}}"></script> <!--parallax-->
    <script src="{{asset('Userassets/js/plugins/countto/jquery.countTo.js')}}"></script> <!--jquery.countTo-->
    <script src="{{asset('Userassets/js/plugins/countdown/jquery.countdown.js')}}"></script> <!--countdown-->
    
    <!--settings-->
    <script src="{{asset('Userassets/js/settings.js')}}"></script> <!--settings-->
